...
function Register() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!agreeToTerms) {
            __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$hot$2d$toast__$5b$external$5d$__$28$react$2d$hot$2d$toast$2c$__esm_import$29$__["default"].error("Please agree to the Terms & Conditions and Privacy Policy to continue.");
            return;
        }
