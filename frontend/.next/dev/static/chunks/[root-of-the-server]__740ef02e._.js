...
function Register() {
    ...
    const handleSubmit = async (e)=>{
        ...
        if (!read) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Abeg read the Terms & Conditions and Privacy Policy first.");
            return;
        }
        // ✅ WhatsApp number validation
        const phoneRegex = /^\+?\d{8,15}$/;
        if (!phoneRegex.test(formData.whatsappNumber)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Please enter a valid WhatsApp number (only digits, 8–15 characters).");
            return;
        }
        if (formData.password !== formData.confirmPassword) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Passwords do not match");
            return;
        }
        setLoading(true);
        try {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    ...
                                                    onChange: (e)=>{
                                                        ...
                                                        if (!/^[\d+]*$/.test(value)) {
                                                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["default"].error("Na Only valid WhatsApp numbers dey allowed.");
                                                            return;
                                                        }
                                                        handleChange(e);
                                                    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__740ef02e._.js.map